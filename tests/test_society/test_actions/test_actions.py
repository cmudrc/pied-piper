...
class TestActionsClass_0(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.model.society.go_and_comeback_and_stay(
            action_queue=action_queue, move_go=move, stay_length=50
        )
    ...
    def test_update(self):
        ...
        self.assertListEqual(
            self.model.society.get_pos(id=self.id_agent), pos_start
        )  # pos
        self.assertEqual(
            self.model.society.get_current_node(id=self.id_agent), self.id_start
        )  # current_node
        ...
        self.assertEqual(
            self.model.infrastructure.get_usage_impact(ids=street), 0
        )  # usage impact
        ...
        self.assertEqual(
            self.model.society.get_current_node(id=self.id_agent), None
        )  # current_node
        ...
        # print(self.model.society.get_pos(id=self.id_agent)) # pos
        self.assertEqual(
            self.model.society.get_current_node(id=self.id_agent), self.id_end
        )  # current_node
        ...
        self.assertEqual(
            self.model.infrastructure.get_usage_impact(ids=street), 1
        )  # usage impact
        acc = self.model.society.accessibility(id=self.id_agent)
        ...
        # print(self.model.society.get_pos(id=self.id_agent)) # pos
        self.assertEqual(
            self.model.society.get_current_node(id=self.id_agent), 1
        )  # current_node
        ...
        self.assertEqual(
            self.model.infrastructure.get_usage_impact(ids=street), 2
        )  # usage impact
        acc = self.model.society.accessibility(id=self.id_agent)
...
class TestActionsClass_1(unittest.TestCase):
    ...
    def test_update(self):
        ...
        self.assertFalse(self.model.society.get_alive(id=self.id_agent))  # agent alive
        self.assertListEqual(
            self.model.society.get_pos(id=self.id_agent), pos_dead
        )  # pos
        self.assertEqual(
            self.model.society.get_current_node(id=self.id_agent), None
        )  # current_node
        food_dead_continued = self.model.society.get_resource(
            id=self.id_agent, name="food"
        )
        self.assertEqual(food_dead_continued, 0)  # resources food
        water_dead_continued = self.model.society.get_resource(
            id=self.id_agent, name="water"
        )
        self.assertEqual(water_dead_continued, water_dead)  # resources water
        energy_dead_continued = self.model.society.get_resource(
            id=self.id_agent, name="energy"
        )
