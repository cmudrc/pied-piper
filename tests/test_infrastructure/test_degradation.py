...
class TestDegradationClass_0(unittest.TestCase):
    ...
    def test_degradation(self):
        ...
        # Initial
        adjusted_length_initial = self.model.infrastructure.get_adjusted_length(
            ids=street
        )
        ...
        adjustment_factor_initial = self.model.infrastructure.adjustment_factor(
            ids=street
        )
        ...
        # Final
        adjusted_length_final = self.model.infrastructure.get_adjusted_length(
            ids=street
        )
        self.assertLess(
            adjusted_length_initial, adjusted_length_final
        )  # Adjusted length
        ...
        adjustment_factor_final = self.model.infrastructure.adjustment_factor(
            ids=street
        )
