...
#env.add_settlement(name="Settlement 2", pos=[200, 20], initiation_date=Date(2020, 1, 2))
#env.add_link(start="Settlement 1", end="Settlement 2", initiation_date=Date(2020, 1, 3))
...
soc.add_agents(n=2, average_resource=average_resource)
