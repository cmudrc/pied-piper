...
from piperabm.data.utqiavik.samples.downtown_200S.permitted_labels import settlement_meshes_permitted_labels
from piperabm.data.utqiavik.samples.downtown_200S.info import settlements_num
