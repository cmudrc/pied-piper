class Query:
    ...
    *** Extends CurrentGraph Class ***
    ...
    def get_node_object(self, index: int):
        """
        Retrieve node element from society based on its index
        """
        result = None
        if index in self.all_indexes():
            result = self.society.get_node_object(index)
        return result
    ...
    def get_node_pos(self, index: int):
        ...
        result = None
        if index in self.all_indexes():
            result = self.society.get_node_pos(index)
        return result
    ...
    def get_edge_object(self, index_start: int, index_end: int):
        ...
        if index_start in self.all_indexes() and \
            ...
            result = self.society.get_edge_object(index_start, index_end)
        return result
    ...
    def get_edge_pos(self, index_start: int, index_end: int):
        ...
        if index_start in self.all_indexes() and \
            index_end in self.all_indexes():
            result = self.society.get_edge_pos(index_start, index_end)
        return result
    
    def all_edges(self, type='all'):
        """
        Filter all edges indexes based on their type
        """
        result = None
        if type == 'all':
    ...
    def find_node(self, node):
        result = None
        node_index = self.society.find_node(node)
