...
class TestEnvironmentCurrentGraphClass(unittest.TestCase):
    ...
    def test_to_current_0(self):
        ...
        current_graph = self.env.current
        path_graph = current_graph.to_path_graph()
        self.assertEqual(len(path_graph.G.nodes()), 0)
        self.assertEqual(len(path_graph.G.edges()), 0)
    ...
    def test_to_current_1(self):
        ...
        current_graph = self.env.current
        path_graph = current_graph.to_path_graph()
        self.assertEqual(len(path_graph.G.nodes()), 1)
        self.assertEqual(len(path_graph.G.edges()), 0)
    ...
    def test_to_current_3(self):
        ...
        current_graph = self.env.current
        path_graph = current_graph.to_path_graph()
        self.assertEqual(len(path_graph.G.nodes()), 2)
        self.assertEqual(len(path_graph.G.edges()), 1)
