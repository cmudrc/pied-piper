...
At each tick, PiperABM updates infrastructure degradation, executes agent OODA policies, and records metrics (e.g., accessibility, travel distance). Agents route on the evolving network; their use contributes to further wear.
