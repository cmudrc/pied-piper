...
PiperABM couples infrastructure and society networks represented as NetworkX graphs, with their interactions summarized in \autoref{fig:overview}. The infrastructure network represents the physical layout: nodes represent homes, markets, and junctions; edges represent streets and access connections from homes and markets to streets. Spatial layouts can be constructed manually or imported from map data.
